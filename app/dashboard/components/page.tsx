...
export default function DesignSystemPage() {
  ...
  return (
    <div style={{ fontFamily: "var(--ds-font-family-sans)" }}>
      <div style={{ maxWidth: "900px", margin: "0 auto", padding: "var(--ds-space-10) var(--ds-space-8)" }}>
        <HStack justify="between" style={{ marginBottom: "var(--ds-space-8)" }}>
          <HStack gap={3}>
            <Text variant="heading" size="2xl">Components</Text>
            <Badge variant="subtle" colorScheme="brand">@designbase/components</Badge>
          </HStack>
