  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-500 mt-1">Here&apos;s what&apos;s happening with your design system.</p>
      </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-6">
          ...
          <div className="flex flex-col gap-2">
            <Link
              ...
              className="flex items-center gap-3 px-4 py-3 rounded-xl bg-indigo-50 text-indigo-700 text-sm font-medium hover:bg-indigo-100 transition-colors"
            >
              <span>◈</span> Edit tokens
            </Link>
            <button className="flex items-center gap-3 px-4 py-3 rounded-xl bg-gray-50 text-gray-700 text-sm font-medium hover:bg-gray-100 transition-colors">
              ...
              <div key={i} className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-gray-700">
                    ...
                    <span className="font-mono text-xs bg-gray-100 px-1.5 py-0.5 rounded text-gray-600">{a.target}</span>
                  </p>
